...
import { ArrowUpRight, Menu, X, Home as HomeIcon, User, Code, Briefcase, Mail, BookOpen } from 'lucide-react';
...
export const FloatingDockNavbar = ({
  navItems,
  className,
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className={cn(
            ...
            "md:hidden", // Hide on desktop since we're using the dock
            className
          )}
          style={{
